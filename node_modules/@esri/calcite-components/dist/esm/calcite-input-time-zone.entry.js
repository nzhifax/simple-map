...
import { u as updateHostInteraction, I as InteractiveContainer } from './interactive-8550e5bc.js';
import { f as getDateTimeFormat, c as connectLocalized, d as disconnectLocalized } from './locale-de3ead11.js';
...
import { c as connectForm, d as disconnectForm, a as afterConnectDefaultValueSet, H as HiddenFormInputSlot } from './form-b15611bf.js';
import './dom-e42c716f.js';
import './guid-3e8856d2.js';
import './resources-ff1bca76.js';
import './component-df464e97.js';
...
async function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
    if (mode === "name") {
        const { groupByName } = await import('./index-4750d02f.js');
    ...
    if (mode === "region") {
        const [{ groupByRegion }, { getCountry }] = await Promise.all([
            import('./index-9f6d0423.js'),
            import('./country-57cad74c.js'),
        ]);
    ...
    const [{ groupByOffset }, { DateEngine }] = await Promise.all([
        import('./index-b29fc3f5.js'),
        import('./index-3ce0be9a.js'),
    ]);
