...
async function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
    if (mode === "name") {
        const { groupByName } = await Promise.resolve().then(function () { return require('./index-bd314483.js'); });
    ...
    if (mode === "region") {
        const [{ groupByRegion }, { getCountry }] = await Promise.all([
            Promise.resolve().then(function () { return require('./index-36684cbe.js'); }),
            Promise.resolve().then(function () { return require('./country-081a3a30.js'); }),
        ]);
    ...
    const [{ groupByOffset }, { DateEngine }] = await Promise.all([
        Promise.resolve().then(function () { return require('./index-8e064962.js'); }),
        Promise.resolve().then(function () { return require('./index-4adddef5.js'); }),
    ]);
