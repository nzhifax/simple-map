...
const Heading = require('./Heading-a4aaaa11.js');
require('./guid-291c0070.js');
require('./resources-2c6b8705.js');
require('./browser-a2b3125e.js');
...
const CalciteNavigation = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e7719159ddeee3397fd1e483c8417978b2b72c66' }, index.h("div", { key: '9d3096793d009c813f1bc42f8fecf46736747afc', class: {
            ...
            } }, index.h("div", { key: '4e35300aeaea8f4ceb1b69d913157306d11a17ec', class: { [CSS$2.hide]: !this.progressSlotHasElement, [SLOTS.progress]: true } }, index.h("slot", { key: '50c46611fcab6af0fe8d458641123d40823334bd', name: SLOTS.progress, onSlotchange: this.handleProgressSlotChange })), index.h("div", { key: '3f0b76520d4de477629397f607c0520472dd9419', class: { [CSS$2.containerContent]: true, [CSS$2.hasProgress]: this.progressSlotHasElement } }, this.renderMenuAction(), index.h("div", { key: 'fb5d2f6a84e5e7a05ced40f955f36e215a923217', class: { [CSS$2.hide]: !this.logoSlotHasElements, [SLOTS.logo]: true } }, index.h("slot", { key: '53aa3fdadf8fedefa9a9aec810e28277629bfb01', name: SLOTS.logo, onSlotchange: this.handleLogoSlotChange })), index.h("slot", { key: '5e83ab5c75b1f1a76bbf0d12f3d3ae43625842f3', name: SLOTS.contentStart, onSlotchange: this.handleContentStartSlotChange }), index.h("slot", { key: '2b531019c48c10fc2d4dadfd34ae61f75233b80a', name: SLOTS.contentCenter, onSlotchange: this.handleContentCenterSlotChange }), index.h("slot", { key: 'feb1fae923a3540158fc889fdaf0c70a8db2f964', name: SLOTS.contentEnd, onSlotchange: this.handleContentEndSlotChange }), index.h("div", { key: '99544caa2724f8ec40d1bbd54b018c28893b822e', class: { [CSS$2.hide]: !this.userSlotHasElements, [SLOTS.user]: true } }, index.h("slot", { key: '2f0a3e1fc4ea5ba221699089b62986b96ed12f75', name: SLOTS.user, onSlotchange: this.handleUserSlotChange })))), index.h(index.Fragment, { key: '0f289531aa4d3805ac0774643f43988095db2a8d' }, index.h("slot", { key: '466d1b0aab0fd4ee4a4736746dd4eb441cfa6ebd', name: SLOTS.navSecondary, onSlotchange: this.handleSecondarySlotChange }), index.h("slot", { key: '3f2520c21f474cf0147865881724269970a9d8bd', name: SLOTS.navTertiary, onSlotchange: this.handleTertiarySlotChange }))));
    }
...
const CalciteNavigationLogo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b76572e79734c7190d373225662f453423450d9a' }, index.h("a", { key: '77d1604fd344f2d5aea65842067a615343aa591b', class: CSS$1.anchor, href: this.href, rel: this.rel, target: this.target }, thumbnail && index.h("img", { key: 'abf6396d63acf26f5ad5e2bb5c9dd280c3728134', alt: this.label || "", class: CSS$1.image, src: thumbnail }), this.icon && this.renderIcon(), this.renderHeaderContent())));
    }
